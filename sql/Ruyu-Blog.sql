...
-- ----------------------------
INSERT INTO `QRTZ_SIMPLE_TRIGGERS` VALUES ('quartzScheduler', '6da64b5bd2ee-161d3704-6bee-45a1-8732-ed05422f5c61', 'DEFAULT', -1, 300000, 170705);
...
-- ----------------------------
INSERT INTO `QRTZ_TRIGGERS` VALUES ('quartzScheduler', '6da64b5bd2ee-161d3704-6bee-45a1-8732-ed05422f5c61', 'DEFAULT', 'refreshTheCache', 'DEFAULT', NULL, 1755397474460, 1755397174460, 5, 'WAITING', 'SIMPLE', 1704198574460, 0, NULL, 0, '');
...
CREATE TABLE `sys_log`  (
  ...
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '操作地址',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2978 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (2867, '信息管理', '上传图片', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.WebsiteInfoController.uploadBackground()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@76f134f0]', 'POST', NULL, '{\"code\":200,\"data\":\"http://8.148.31.90:9000/blog/websiteInfo/background/a447eb3b-31cb-4a8f-af0a-54a30c0d7b81.jpg\",\"msg\":\"success\"}', '/websiteInfo/upload/background', 7732, '上传站长资料卡背景', '2025-08-16 20:34:34', '2025-08-16 20:34:34', 0);
INSERT INTO `sys_log` VALUES (2868, '信息管理', '获取', 'unknown-1702606997', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 63, '前台获取所有前台首页Banner图片', '2025-08-16 20:34:43', '2025-08-16 20:34:43', 0);
INSERT INTO `sys_log` VALUES (2869, '信息管理', '上传图片', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.WebsiteInfoController.upload()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@77954a6e]', 'POST', NULL, '{\"code\":200,\"data\":\"http://8.148.31.90:9000/blog/websiteInfo/avatar/d88cb175-7bce-4be6-9057-08ee041301f5.jpg\",\"msg\":\"success\"}', '/websiteInfo/upload/avatar', 1354, '上传站长头像', '2025-08-16 20:35:46', '2025-08-16 20:35:46', 0);
INSERT INTO `sys_log` VALUES (2870, '信息管理', '获取', 'unknown-1702606997', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 32, '前台获取所有前台首页Banner图片', '2025-08-16 20:35:52', '2025-08-16 20:35:52', 0);
INSERT INTO `sys_log` VALUES (2871, '文章管理', '获取', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.listArticle()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[{\"articleCover\":\"http://43.136.78.47:9000/blog/article/articleCover/cfce7f30-f9e7-4ca4-81b9-c0831cc9c221.png\",\"articleTitle\":\"测试\",\"articleType\":1,\"categoryId\":1,\"categoryName\":\"生活\",\"createTime\":1709100336000,\"id\":40,\"isTop\":0,\"status\":1,\"tagsName\":[\"python\"],\"userId\":1,\"userName\":\"ADMIN\",\"visitCount\":0},{\"articleCover\":\"http://43.136.78.47:9000/blog/article/articleCover/d4574635-ba1d-4c01-beda-1ad25c4db0e3.png\",\"articleTitle\":\"测试文章\",\"articleType\":1,\"categoryId\":4,\"categoryName\":\"分类\",\"createTime\":1704375139000,\"id\":32,\"isTop\":0,\"status\":1,\"tagsName\":[\"python\",\"c#\"],\"userId\":1,\"userName\":\"ADMIN\",\"visitCount\":8},{\"articleCover\":\"http://cdn.kuailemao.lielfw.cn/articleCover/Sara11676693097117968.png\",\"articleTitle\":\"java的继承\",\"articleType\":1,\"categoryId\":2,\"categoryName\":\"技术\",\"createTime\":1697308005000,\"id\":1,\"isTop\":1,\"status\":1,\"tagsName\":[\"java\",\"python\",\"c#\"],\"userId\":1,\"userName\":\"ADMIN\",\"visitCount\":266},{\"articleCover\":\"http://cdn.kuailemao.lielfw.cn/PicGo/idea%E8%83%8C%E6%99%AF.png\",\"articleTitle\":\"今天出去玩了\",\"articleType\":1,\"categoryId\":2,\"categoryName\":\"技术\",\"createTime\":1697308005000,\"id\":3,\"isTop\":1,\"status\":1,\"tagsName\":[\"c#\",\"开心\"],\"userId\":1,\"userName\":\"ADMIN\",\"visitCount\":133},{\"articleCover\":\"http://cdn.kuailemao.lielfw.cn/PicGo/idea%E8%83%8C%E6%99%AF.png\",\"articleTitle\":\"测试分类3\",\"articleType\":1,\"categoryId\":3,\"categoryName\":\"娱乐\",\"createTime\":1697308005000,\"id\":24,\"isTop\":0,\"status\":1,\"tagsName\":[\"python\",\"c++\"],\"userId\":1,\"userName\":\"ADMIN\",\"visitCount\":131}],\"msg\":\"success\"}', '/article/back/list', 557, '获取所有的文章列表', '2025-08-16 20:41:22', '2025-08-16 20:41:22', 0);
INSERT INTO `sys_log` VALUES (2872, '文章管理', '获取', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.getArticleEcho()', '[1]', 'GET', NULL, '{\"code\":200,\"data\":{\"articleContent\":\"# 🍖2、继承\\r\\n#### 🍟2.1、继承的基本概念\\r\\n> 继承是面向对象的三大特征之一，继承可以解决编程中代码冗余的问题，是实现代码重用的重要手段之一。\\r\\n> **语法：**\\r\\n> [ 访问修饰符 ] class  \\\\<SubClass\\\\>  extends <SuperClass\\\\>{\\r\\n>\\r\\n> }\\r\\n\\r\\n其中，SubClass 被称为子类或派生类，SuperClass 被称为父类或基类。\\r\\n\\r\\n> Java 继承规则如下：\\r\\n> 1、可以继承父类中 public 和 protected 修饰的属性和方法，不论子类和父类是否在同一包中。\\r\\n> 2、可以继承默认访问修饰符修饰的属性和方法，但是子类和父类必须在同一包中\\r\\n> 3、无法继承 private 修饰的属性和方法\\r\\n> 4、无法继承父类的构造方法\\r\\n\\r\\n**注意：**\\r\\n> 在 Java 中只支持单继承，即每个类只能有一个直接父类\\r\\n\\r\\n#### 🍟2.2、继承的应用\\r\\n如下：\\r\\n```java\\r\\n    /**\\r\\n    *动物父类\\r\\n    */\\r\\n\\tpublic class Animal {\\r\\n    public void cry(){\\r\\n        System.out.println(\\\"动物叫。。。。\\\");\\r\\n    }\\r\\n}\\r\\n\\t/**\\r\\n\\t*\\t继承了动物类的小猫类也有 cry() 方法（子类）\\r\\n\\t*/\\r\\npublic class Cat extends Animal {\\r\\n   // 有父类的方法与属性 \\r\\n}\\r\\n```\\r\\n#### 🍟2.3、Object\\r\\n> Object 类属性超级父类（老祖宗），当一个类没有任何继承的时候，默认继承 Object 类，自带 Object 类里面的 方法与属性\\r\\n\\r\\n**注意：**\\r\\n> 子类被创建对象的时候必是先执行 Object 类的构造方法，因为构造方法第一行中有隐藏的 super() 调用父类构造方法，最终的父类一定是 Object 类\\r\\n\\r\\n#### 🍟2.4、继承关系中的方法重写\\r\\n> 子类通过继承可以拥有和父类相同的特征和行为，另外，子类也可以定义自己特有的行为，既沿袭了父类的方法名称，又重新实现了父类方法，这就是方法重写。\\r\\n\\r\\n> 在子类中可以根据需求对从父类继承的方法进行重写编写，这被称为方法重写或方法覆盖。\\r\\n\\r\\n**方法重写必须遵守以下规则：**\\r\\n* 重写方法和被重写方法必须具有相同的方法名\\r\\n* 重写方法和被重写方法必须具有相同的参数列表\\r\\n* 重写方法的返回值类型必须和被重写方法的返回值类型相同或是其子类\\r\\n* 重写方法不能缩小被重写方法的访问权限\\r\\n\\r\\n**重写的时候可以在方法上面使用注解：**\\r\\n\\r\\n> @Override\\r\\n> @Override 是用 Java 注解的方法表示该方法重写了父类方法，可以写也可以不写，在功能实现上没有区别，但是通过 @Override 注解，程序更加方便阅读。另外，编译器也会帮助验证 @Override 下面的方法名是否是父类所有的。如果其不符合方法重写规则，则会报错。\\r\\n\\r\\n**提示：**\\r\\n> Java 注解又被称为 Java 标注，是 Java 5 引入的一种注解机制。  \\r\\n\\r\\n#### 🍟2.5、方法重载和方法重写的区别\\r\\n* 方法重载涉及同一个类中的同名方法，要求方法名相同，参数列表不同，与返回值类型和访问修饰符无关\\r\\n* 方法重写涉及的是子类和父类之间的同名方法，要求方法名相同，参数列表相同，返回值类型i相同或是其子类\\r\\n\\r\\n#### 🍟2.6、super关键字\\r\\n> 如果想在子类中调用父类的被重写的方法，可以使用 ” super.方法名 “实现\\r\\n\\r\\nsuper 关键字代表对当前对象的直接父类对象的默认引用。在子类中可以通过 super 关键字访问父类的成员，包括父类的属性和方法。语法如下：\\r\\n> 语法：\\r\\n> 访问父类构造方法 ：super(参数)\\r\\n> 访问父类属性 / 方法 ：super.< 父类属性 / 方法 \\\\>\\r\\n\\r\\n使用 super 关键字，需要注意以下几点：\\r\\n* super 关键字必须出现在子类（子类的方法和构造方法）中，而不允许在其他位置。\\r\\n* 可以访问父类的成员，如父类的属性，方法，构造方法。\\r\\n* 注意访问权限的限制，如无法通过 super 关键字访问 private 成员。\\r\\n\\r\\n**注意：**\\r\\n\\r\\n> 1、在构造方法中如果有 this 语句或 super 语句，则只能是第一条语句。\\r\\n> 2、在一个构造方法中，不允许同时使用 this 关键字和 super 关键字调用构造方法（否则就有两条第一条语句）。\\r\\n> 3、在静态方法中不允许出现 this 关键字或 super 关键字。\\r\\n> 4、在实例方法中，this 语句和 super 语句不要求是第一条语句，可以共存。\\r\\n> 5、子类构造方法中第一行有隐藏的 **super( )** 调用父类构造方法，最终父类一定是 Object 类\\r\\n\\r\\n#### 🍟2.7、继承关系中的构造方法\\r\\n在 Java 中，一个类的构造方法在如下两种情况下会被执行：\\r\\n* 创建该类对象（实例化）\\r\\n* 创建该类的子类对象（子类的实例化）\\r\\n\\r\\n> 子类在实例化时，会首先执行其父类的构造方法，然后才会执行子类的构造方法。\\r\\n> 在 Java 语言中，当创建一个对象时，Java 虚拟机（JVM）会按照父类——>子类的顺序执行一系列的构造方法。\\r\\n\\r\\n**子类继承父类时构造方法的调用规则如下：**\\r\\n* 如果在类的构造方法中没有通过 super 关键字显式调用父类地带参构造方法，也没有通过 this 关键字显式调用自身地其他构造方法，则系统会默认先调用父类的无参构造方法。在这种情况下，是否写 “ super( );  ”语句，效果是一样的。\\r\\n* 如果在子类的构造方法中通过 super 关键字显式地调用了父类地带参构造方法，那么将执行父类相应的构造方法，而不执行父类无参构造方法。\\r\\n* 如果在子类的构造方法中通过 this 关键字显式地调用了自身地其他构造方法，那么在相应构造方法中遵循以上两条规则。\\r\\n* 如果存在多级继承关系，则在创建一个子类对象时，以上规则会多次向上更高一级父类应用，直到执行顶级父类 Object 类的无参构造方法为止。\\r\\n\\r\\n<center>-----------------------<b style=\\\"color:#C3C326\\\">世界会向那些有目标和远见的人让路。</b>-----------------------</center>\",\"articleCover\":\"http://cdn.kuailemao.lielfw.cn/articleCover/Sara11676693097117968.png\",\"articleTitle\":\"java的继承\",\"articleType\":1,\"categoryId\":2,\"id\":1,\"isTop\":1,\"status\":1,\"tagId\":[1,2,3]},\"msg\":\"success\"}', '/article/back/echo/1', 76, '回显文章数据', '2025-08-16 20:41:28', '2025-08-16 20:41:28', 0);
INSERT INTO `sys_log` VALUES (2873, '文章管理', '上传图片', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.uploadArticleCover()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@45c548b7]', 'POST', NULL, '{\"code\":200,\"data\":\"http://8.148.31.90:9000/blog/article/articleCover/f1e08d92-61d9-499b-8f52-9043b6f7030d.jpg\",\"msg\":\"success\"}', '/article/upload/articleCover', 77, '上传文章封面', '2025-08-16 20:41:38', '2025-08-16 20:41:38', 0);
INSERT INTO `sys_log` VALUES (2874, '文章管理', '新增', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.publish()', '[{\"articleContent\":\"# 🍖2、继承\\n#### 🍟2.1、继承的基本概念\\n> 继承是面向对象的三大特征之一，继承可以解决编程中代码冗余的问题，是实现代码重用的重要手段之一。\\n> **语法：**\\n> [ 访问修饰符 ] class  \\\\<SubClass\\\\>  extends <SuperClass\\\\>{\\n>\\n> }\\n\\n其中，SubClass 被称为子类或派生类，SuperClass 被称为父类或基类。\\n\\n> Java 继承规则如下：\\n> 1、可以继承父类中 public 和 protected 修饰的属性和方法，不论子类和父类是否在同一包中。\\n> 2、可以继承默认访问修饰符修饰的属性和方法，但是子类和父类必须在同一包中\\n> 3、无法继承 private 修饰的属性和方法\\n> 4、无法继承父类的构造方法\\n\\n**注意：**\\n> 在 Java 中只支持单继承，即每个类只能有一个直接父类\\n\\n#### 🍟2.2、继承的应用\\n如下：\\n```java\\n    /**\\n    *动物父类\\n    */\\n\\tpublic class Animal {\\n    public void cry(){\\n        System.out.println(\\\"动物叫。。。。\\\");\\n    }\\n}\\n\\t/**\\n\\t*\\t继承了动物类的小猫类也有 cry() 方法（子类）\\n\\t*/\\npublic class Cat extends Animal {\\n   // 有父类的方法与属性 \\n}\\n```\\n#### 🍟2.3、Object\\n> Object 类属性超级父类（老祖宗），当一个类没有任何继承的时候，默认继承 Object 类，自带 Object 类里面的 方法与属性\\n\\n**注意：**\\n> 子类被创建对象的时候必是先执行 Object 类的构造方法，因为构造方法第一行中有隐藏的 super() 调用父类构造方法，最终的父类一定是 Object 类\\n\\n#### 🍟2.4、继承关系中的方法重写\\n> 子类通过继承可以拥有和父类相同的特征和行为，另外，子类也可以定义自己特有的行为，既沿袭了父类的方法名称，又重新实现了父类方法，这就是方法重写。\\n\\n> 在子类中可以根据需求对从父类继承的方法进行重写编写，这被称为方法重写或方法覆盖。\\n\\n**方法重写必须遵守以下规则：**\\n* 重写方法和被重写方法必须具有相同的方法名\\n* 重写方法和被重写方法必须具有相同的参数列表\\n* 重写方法的返回值类型必须和被重写方法的返回值类型相同或是其子类\\n* 重写方法不能缩小被重写方法的访问权限\\n\\n**重写的时候可以在方法上面使用注解：**\\n\\n> @Override\\n> @Override 是用 Java 注解的方法表示该方法重写了父类方法，可以写也可以不写，在功能实现上没有区别，但是通过 @Override 注解，程序更加方便阅读。另外，编译器也会帮助验证 @Override 下面的方法名是否是父类所有的。如果其不符合方法重写规则，则会报错。\\n\\n**提示：**\\n> Java 注解又被称为 Java 标注，是 Java 5 引入的一种注解机制。  \\n\\n#### 🍟2.5、方法重载和方法重写的区别\\n* 方法重载涉及同一个类中的同名方法，要求方法名相同，参数列表不同，与返回值类型和访问修饰符无关\\n* 方法重写涉及的是子类和父类之间的同名方法，要求方法名相同，参数列表相同，返回值类型i相同或是其子类\\n\\n#### 🍟2.6、super关键字\\n> 如果想在子类中调用父类的被重写的方法，可以使用 ” super.方法名 “实现\\n\\nsuper 关键字代表对当前对象的直接父类对象的默认引用。在子类中可以通过 super 关键字访问父类的成员，包括父类的属性和方法。语法如下：\\n> 语法：\\n> 访问父类构造方法 ：super(参数)\\n> 访问父类属性 / 方法 ：super.< 父类属性 / 方法 \\\\>\\n\\n使用 super 关键字，需要注意以下几点：\\n* super 关键字必须出现在子类（子类的方法和构造方法）中，而不允许在其他位置。\\n* 可以访问父类的成员，如父类的属性，方法，构造方法。\\n* 注意访问权限的限制，如无法通过 super 关键字访问 private 成员。\\n\\n**注意：**\\n\\n> 1、在构造方法中如果有 this 语句或 super 语句，则只能是第一条语句。\\n> 2、在一个构造方法中，不允许同时使用 this 关键字和 super 关键字调用构造方法（否则就有两条第一条语句）。\\n> 3、在静态方法中不允许出现 this 关键字或 super 关键字。\\n> 4、在实例方法中，this 语句和 super 语句不要求是第一条语句，可以共存。\\n> 5、子类构造方法中第一行有隐藏的 **super( )** 调用父类构造方法，最终父类一定是 Object 类\\n\\n#### 🍟2.7、继承关系中的构造方法\\n在 Java 中，一个类的构造方法在如下两种情况下会被执行：\\n* 创建该类对象（实例化）\\n* 创建该类的子类对象（子类的实例化）\\n\\n> 子类在实例化时，会首先执行其父类的构造方法，然后才会执行子类的构造方法。\\n> 在 Java 语言中，当创建一个对象时，Java 虚拟机（JVM）会按照父类——>子类的顺序执行一系列的构造方法。\\n\\n**子类继承父类时构造方法的调用规则如下：**\\n* 如果在类的构造方法中没有通过 super 关键字显式调用父类地带参构造方法，也没有通过 this 关键字显式调用自身地其他构造方法，则系统会默认先调用父类的无参构造方法。在这种情况下，是否写 “ super( );  ”语句，效果是一样的。\\n* 如果在子类的构造方法中通过 super 关键字显式地调用了父类地带参构造方法，那么将执行父类相应的构造方法，而不执行父类无参构造方法。\\n* 如果在子类的构造方法中通过 this 关键字显式地调用了自身地其他构造方法，那么在相应构造方法中遵循以上两条规则。\\n* 如果存在多级继承关系，则在创建一个子类对象时，以上规则会多次向上更高一级父类应用，直到执行顶级父类 Object 类的无参构造方法为止。\\n\\n<center>-----------------------<b style=\\\"color:#C3C326\\\">世界会向那些有目标和远见的人让路。</b>-----------------------</center>\",\"articleCover\":\"http://8.148.31.90:9000/blog/article/articleCover/f1e08d92-61d9-499b-8f52-9043b6f7030d.jpg\",\"articleTitle\":\"java的继承\",\"articleType\":1,\"categoryId\":2,\"id\":1,\"isTop\":1,\"status\":1,\"tagId\":[1,2,3]}]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/publish', 466, '发布文章', '2025-08-16 20:41:39', '2025-08-16 20:41:39', 0);
INSERT INTO `sys_log` VALUES (2875, '文章管理', '获取', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.getArticleEcho()', '[3]', 'GET', NULL, '{\"code\":200,\"data\":{\"articleContent\":\"好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，\",\"articleCover\":\"http://cdn.kuailemao.lielfw.cn/PicGo/idea%E8%83%8C%E6%99%AF.png\",\"articleTitle\":\"今天出去玩了\",\"articleType\":1,\"categoryId\":2,\"id\":3,\"isTop\":1,\"status\":1,\"tagId\":[3,5]},\"msg\":\"success\"}', '/article/back/echo/3', 58, '回显文章数据', '2025-08-16 20:41:49', '2025-08-16 20:41:49', 0);
INSERT INTO `sys_log` VALUES (2876, '文章管理', '上传图片', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.uploadArticleCover()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@40249f30]', 'POST', NULL, '{\"code\":200,\"data\":\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"msg\":\"success\"}', '/article/upload/articleCover', 52, '上传文章封面', '2025-08-16 20:41:58', '2025-08-16 20:41:58', 0);
INSERT INTO `sys_log` VALUES (2877, '文章管理', '新增', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.publish()', '[{\"articleContent\":\"好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，\",\"articleCover\":\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"articleTitle\":\"今天出去玩了\",\"articleType\":1,\"categoryId\":2,\"id\":3,\"isTop\":1,\"status\":1,\"tagId\":[3,5]}]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/publish', 32, '发布文章', '2025-08-16 20:42:00', '2025-08-16 20:42:00', 0);
INSERT INTO `sys_log` VALUES (2878, '文章管理', '修改', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.updateArticleIsTop()', '[32,1]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/back/update/isTop', 34, '修改文章是否顶置', '2025-08-16 20:42:03', '2025-08-16 20:42:03', 0);
INSERT INTO `sys_log` VALUES (2879, '文章管理', '获取', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.getArticleEcho()', '[32]', 'GET', NULL, '{\"code\":200,\"data\":{\"articleContent\":\"## 这是一篇测试文章\\n> 你看见这篇文章说明后台发布文章功能成功\\n\\n```mermaid\\ngantt\\ntitle A Gantt Diagram\\ndateFormat  YYYY-MM-DD\\nsection Section\\nA task  :a1, 2014-01-01, 30d\\nAnother task  :after a1, 20d\\n```\\n\\n### 图表\\n```mermaid\\nclassDiagram\\n  class Animal\\n  Vehicle <|-- Car\\n```\\n\",\"articleCover\":\"http://43.136.78.47:9000/blog/article/articleCover/d4574635-ba1d-4c01-beda-1ad25c4db0e3.png\",\"articleTitle\":\"测试文章\",\"articleType\":1,\"categoryId\":4,\"id\":32,\"isTop\":1,\"status\":1,\"tagId\":[2,3]},\"msg\":\"success\"}', '/article/back/echo/32', 93, '回显文章数据', '2025-08-16 20:42:07', '2025-08-16 20:42:07', 0);
INSERT INTO `sys_log` VALUES (2880, '文章管理', '上传图片', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.uploadArticleCover()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@77b254a7]', 'POST', NULL, '{\"code\":200,\"data\":\"http://8.148.31.90:9000/blog/article/articleCover/2aa6ea41-dee3-4381-93b0-b520a494403a.jpg\",\"msg\":\"success\"}', '/article/upload/articleCover', 29, '上传文章封面', '2025-08-16 20:42:16', '2025-08-16 20:42:16', 0);
INSERT INTO `sys_log` VALUES (2881, '文章管理', '新增', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.publish()', '[{\"articleContent\":\"## 这是一篇测试文章\\n> 你看见这篇文章说明后台发布文章功能成功\\n\\n```mermaid\\ngantt\\ntitle A Gantt Diagram\\ndateFormat  YYYY-MM-DD\\nsection Section\\nA task  :a1, 2014-01-01, 30d\\nAnother task  :after a1, 20d\\n```\\n\\n### 图表\\n```mermaid\\nclassDiagram\\n  class Animal\\n  Vehicle <|-- Car\\n```\\n\",\"articleCover\":\"http://8.148.31.90:9000/blog/article/articleCover/2aa6ea41-dee3-4381-93b0-b520a494403a.jpg\",\"articleTitle\":\"测试文章\",\"articleType\":1,\"categoryId\":4,\"id\":32,\"isTop\":1,\"status\":1,\"tagId\":[2,3]}]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/publish', 28, '发布文章', '2025-08-16 20:42:17', '2025-08-16 20:42:17', 0);
INSERT INTO `sys_log` VALUES (2882, '信息管理', '获取', 'unknown-1702606997', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 14, '前台获取所有前台首页Banner图片', '2025-08-16 20:42:24', '2025-08-16 20:42:24', 0);
INSERT INTO `sys_log` VALUES (2883, '文章管理', '修改', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.updateArticleIsTop()', '[40,1]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/back/update/isTop', 9, '修改文章是否顶置', '2025-08-16 20:42:49', '2025-08-16 20:42:49', 0);
INSERT INTO `sys_log` VALUES (2884, '文章管理', '修改', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.updateArticleIsTop()', '[40,0]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/back/update/isTop', 8, '修改文章是否顶置', '2025-08-16 20:42:50', '2025-08-16 20:42:50', 0);
INSERT INTO `sys_log` VALUES (2885, '文章管理', '修改', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.updateArticleIsTop()', '[32,0]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/back/update/isTop', 13, '修改文章是否顶置', '2025-08-16 20:42:52', '2025-08-16 20:42:52', 0);
INSERT INTO `sys_log` VALUES (2886, '文章管理', '修改', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.updateArticleIsTop()', '[3,0]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/back/update/isTop', 19, '修改文章是否顶置', '2025-08-16 20:42:53', '2025-08-16 20:42:53', 0);
INSERT INTO `sys_log` VALUES (2887, '文章管理', '获取', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.getArticleEcho()', '[40]', 'GET', NULL, '{\"code\":200,\"data\":{\"articleContent\":\"新文章\",\"articleCover\":\"http://43.136.78.47:9000/blog/article/articleCover/cfce7f30-f9e7-4ca4-81b9-c0831cc9c221.png\",\"articleTitle\":\"测试\",\"articleType\":1,\"categoryId\":1,\"id\":40,\"isTop\":0,\"status\":1,\"tagId\":[2]},\"msg\":\"success\"}', '/article/back/echo/40', 9, '回显文章数据', '2025-08-16 20:43:00', '2025-08-16 20:43:00', 0);
INSERT INTO `sys_log` VALUES (2888, '文章管理', '上传图片', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.uploadArticleCover()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@486d3aeb]', 'POST', NULL, '{\"code\":200,\"data\":\"http://8.148.31.90:9000/blog/article/articleCover/eb549b9e-027a-4224-ac0d-2ff679afc2fb.jpg\",\"msg\":\"success\"}', '/article/upload/articleCover', 21, '上传文章封面', '2025-08-16 20:43:07', '2025-08-16 20:43:07', 0);
INSERT INTO `sys_log` VALUES (2889, '文章管理', '新增', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.publish()', '[{\"articleContent\":\"新文章\",\"articleCover\":\"http://8.148.31.90:9000/blog/article/articleCover/eb549b9e-027a-4224-ac0d-2ff679afc2fb.jpg\",\"articleTitle\":\"测试\",\"articleType\":1,\"categoryId\":1,\"id\":40,\"isTop\":0,\"status\":1,\"tagId\":[2]}]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/publish', 28, '发布文章', '2025-08-16 20:43:08', '2025-08-16 20:43:08', 0);
INSERT INTO `sys_log` VALUES (2890, '文章管理', '获取', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.getArticleEcho()', '[24]', 'GET', NULL, '{\"code\":200,\"data\":{\"articleContent\":\"好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，\",\"articleCover\":\"http://cdn.kuailemao.lielfw.cn/PicGo/idea%E8%83%8C%E6%99%AF.png\",\"articleTitle\":\"测试分类3\",\"articleType\":1,\"categoryId\":3,\"id\":24,\"isTop\":0,\"status\":1,\"tagId\":[2,4]},\"msg\":\"success\"}', '/article/back/echo/24', 9, '回显文章数据', '2025-08-16 20:43:18', '2025-08-16 20:43:18', 0);
INSERT INTO `sys_log` VALUES (2891, '文章管理', '上传图片', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.uploadArticleCover()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@4994a3c1]', 'POST', NULL, '{\"code\":200,\"data\":\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"msg\":\"success\"}', '/article/upload/articleCover', 12, '上传文章封面', '2025-08-16 20:43:26', '2025-08-16 20:43:26', 0);
INSERT INTO `sys_log` VALUES (2892, '文章管理', '新增', 'ADMIN', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.ArticleController.publish()', '[{\"articleContent\":\"好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，\",\"articleCover\":\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"articleTitle\":\"测试分类3\",\"articleType\":1,\"categoryId\":3,\"id\":24,\"isTop\":0,\"status\":1,\"tagId\":[2,4]}]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/article/publish', 25, '发布文章', '2025-08-16 20:43:26', '2025-08-16 20:43:26', 0);
INSERT INTO `sys_log` VALUES (2893, '信息管理', '获取', 'unknown-1702606997', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 3, '前台获取所有前台首页Banner图片', '2025-08-16 20:43:32', '2025-08-16 20:43:32', 0);
INSERT INTO `sys_log` VALUES (2894, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 4, '前台获取所有前台首页Banner图片', '2025-08-16 20:44:05', '2025-08-16 20:44:05', 0);
INSERT INTO `sys_log` VALUES (2895, '邮件发送', '邮件发送', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.PublicController.askVerifyCode()', '[\"1911779729@qq.com\",\"register\"]', 'GET', NULL, '{\"code\":200,\"data\":\"验证码已发送，请注意查收！\",\"msg\":\"success\"}', '/public/ask-code', 58, '邮件发送', '2025-08-16 20:45:08', '2025-08-16 20:45:08', 0);
INSERT INTO `sys_log` VALUES (2896, '邮件发送', '邮件发送', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.PublicController.askVerifyCode()', '[\"1911779729@qq.com\",\"register\"]', 'GET', NULL, '{\"code\":200,\"data\":\"验证码已发送，请注意查收！\",\"msg\":\"success\"}', '/public/ask-code', 2, '邮件发送', '2025-08-16 20:46:39', '2025-08-16 20:46:39', 0);
INSERT INTO `sys_log` VALUES (2897, '邮件发送', '邮件发送', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.PublicController.askVerifyCode()', '[\"1911779729@qq.com\",\"register\"]', 'GET', NULL, '{\"code\":200,\"data\":\"验证码已发送，请注意查收！\",\"msg\":\"success\"}', '/public/ask-code', 3, '邮件发送', '2025-08-16 20:54:30', '2025-08-16 20:54:30', 0);
INSERT INTO `sys_log` VALUES (2898, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 6, '前台获取所有前台首页Banner图片', '2025-08-16 22:24:28', '2025-08-16 22:24:28', 0);
INSERT INTO `sys_log` VALUES (2899, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[1,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 250, NULL, '2025-08-16 22:24:55', '2025-08-16 22:24:55', 0);
INSERT INTO `sys_log` VALUES (2900, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 8, NULL, '2025-08-16 22:24:55', '2025-08-16 22:24:55', 0);
INSERT INTO `sys_log` VALUES (2901, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 8, NULL, '2025-08-16 22:24:56', '2025-08-16 22:24:56', 0);
INSERT INTO `sys_log` VALUES (2902, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 17, NULL, '2025-08-16 22:24:56', '2025-08-16 22:24:56', 0);
INSERT INTO `sys_log` VALUES (2903, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 6, NULL, '2025-08-16 22:24:57', '2025-08-16 22:24:57', 0);
INSERT INTO `sys_log` VALUES (2904, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 13, NULL, '2025-08-16 22:24:57', '2025-08-16 22:24:57', 0);
INSERT INTO `sys_log` VALUES (2905, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 8, NULL, '2025-08-16 22:24:57', '2025-08-16 22:24:57', 0);
INSERT INTO `sys_log` VALUES (2906, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 16, NULL, '2025-08-16 22:24:57', '2025-08-16 22:24:57', 0);
INSERT INTO `sys_log` VALUES (2907, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 8, NULL, '2025-08-16 22:24:57', '2025-08-16 22:24:57', 0);
INSERT INTO `sys_log` VALUES (2908, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 5, NULL, '2025-08-16 22:24:58', '2025-08-16 22:24:58', 0);
INSERT INTO `sys_log` VALUES (2909, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 8, NULL, '2025-08-16 22:24:58', '2025-08-16 22:24:58', 0);
INSERT INTO `sys_log` VALUES (2910, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 6, NULL, '2025-08-16 22:25:00', '2025-08-16 22:25:00', 0);
INSERT INTO `sys_log` VALUES (2911, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 290, NULL, '2025-08-16 22:25:01', '2025-08-16 22:25:01', 0);
INSERT INTO `sys_log` VALUES (2912, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 18, NULL, '2025-08-16 22:25:02', '2025-08-16 22:25:02', 0);
INSERT INTO `sys_log` VALUES (2913, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 9, NULL, '2025-08-16 22:25:02', '2025-08-16 22:25:02', 0);
INSERT INTO `sys_log` VALUES (2914, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 8, NULL, '2025-08-16 22:25:04', '2025-08-16 22:25:04', 0);
INSERT INTO `sys_log` VALUES (2915, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 8, NULL, '2025-08-16 22:25:04', '2025-08-16 22:25:04', 0);
INSERT INTO `sys_log` VALUES (2916, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 11, NULL, '2025-08-16 22:25:04', '2025-08-16 22:25:04', 0);
INSERT INTO `sys_log` VALUES (2917, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 6, NULL, '2025-08-16 22:25:05', '2025-08-16 22:25:05', 0);
INSERT INTO `sys_log` VALUES (2918, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 7, NULL, '2025-08-16 22:25:05', '2025-08-16 22:25:05', 0);
INSERT INTO `sys_log` VALUES (2919, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 12, NULL, '2025-08-16 22:25:05', '2025-08-16 22:25:05', 0);
INSERT INTO `sys_log` VALUES (2920, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 11, NULL, '2025-08-16 22:25:05', '2025-08-16 22:25:05', 0);
INSERT INTO `sys_log` VALUES (2921, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 5, NULL, '2025-08-16 22:25:05', '2025-08-16 22:25:05', 0);
INSERT INTO `sys_log` VALUES (2922, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 9, NULL, '2025-08-16 22:25:06', '2025-08-16 22:25:06', 0);
INSERT INTO `sys_log` VALUES (2923, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 13, '前台获取所有前台首页Banner图片', '2025-08-16 22:25:09', '2025-08-16 22:25:09', 0);
INSERT INTO `sys_log` VALUES (2924, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 4, '前台获取所有前台首页Banner图片', '2025-08-16 22:26:04', '2025-08-16 22:26:04', 0);
INSERT INTO `sys_log` VALUES (2925, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 7, '前台获取所有前台首页Banner图片', '2025-08-16 22:26:29', '2025-08-16 22:26:29', 0);
INSERT INTO `sys_log` VALUES (2926, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[1,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 7, NULL, '2025-08-16 22:26:30', '2025-08-16 22:26:30', 0);
INSERT INTO `sys_log` VALUES (2927, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 6, NULL, '2025-08-16 22:26:31', '2025-08-16 22:26:31', 0);
INSERT INTO `sys_log` VALUES (2928, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 13, '前台获取所有前台首页Banner图片', '2025-08-16 22:26:32', '2025-08-16 22:26:32', 0);
INSERT INTO `sys_log` VALUES (2929, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 21, '前台获取所有前台首页Banner图片', '2025-08-16 22:26:55', '2025-08-16 22:26:55', 0);
INSERT INTO `sys_log` VALUES (2930, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[1,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 7, NULL, '2025-08-16 22:27:01', '2025-08-16 22:27:01', 0);
INSERT INTO `sys_log` VALUES (2931, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 7, NULL, '2025-08-16 22:27:03', '2025-08-16 22:27:03', 0);
INSERT INTO `sys_log` VALUES (2932, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 6, NULL, '2025-08-16 22:27:03', '2025-08-16 22:27:03', 0);
INSERT INTO `sys_log` VALUES (2933, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 10, NULL, '2025-08-16 22:27:03', '2025-08-16 22:27:03', 0);
INSERT INTO `sys_log` VALUES (2934, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 5, NULL, '2025-08-16 22:27:04', '2025-08-16 22:27:04', 0);
INSERT INTO `sys_log` VALUES (2935, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 6, NULL, '2025-08-16 22:27:04', '2025-08-16 22:27:04', 0);
INSERT INTO `sys_log` VALUES (2936, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 10, NULL, '2025-08-16 22:27:05', '2025-08-16 22:27:05', 0);
INSERT INTO `sys_log` VALUES (2937, '相册管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 4, NULL, '2025-08-16 22:27:05', '2025-08-16 22:27:05', 0);
INSERT INTO `sys_log` VALUES (2938, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 4, '前台获取所有前台首页Banner图片', '2025-08-16 22:27:58', '2025-08-16 22:27:58', 0);
INSERT INTO `sys_log` VALUES (2939, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 38, '前台获取所有前台首页Banner图片', '2025-08-16 23:31:24', '2025-08-16 23:31:24', 0);
INSERT INTO `sys_log` VALUES (2940, '邮件发送', '邮件发送', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.PublicController.askVerifyCode()', '[\"1911779729@qq.com\",\"register\"]', 'GET', NULL, '{\"code\":200,\"data\":\"验证码已发送，请注意查收！\",\"msg\":\"success\"}', '/public/ask-code', 138, '邮件发送', '2025-08-16 23:31:51', '2025-08-16 23:31:51', 0);
INSERT INTO `sys_log` VALUES (2941, '前台注册', '新增', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.UserController.register()', '[{\"code\":\"355165\",\"email\":\"1911779729@qq.com\",\"password\":\"123456\",\"username\":\"hq\"}]', 'POST', NULL, '{\"code\":200,\"msg\":\"success\"}', '/user/register', 274, '用户注册', '2025-08-16 23:32:08', '2025-08-16 23:32:08', 0);
INSERT INTO `sys_log` VALUES (2942, '信息管理', '获取', 'hq', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 10, '前台获取所有前台首页Banner图片', '2025-08-16 23:32:17', '2025-08-16 23:32:17', 0);
INSERT INTO `sys_log` VALUES (2943, '信息管理', '获取', 'hq', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 20, '前台获取所有前台首页Banner图片', '2025-08-16 23:33:21', '2025-08-16 23:33:21', 0);
INSERT INTO `sys_log` VALUES (2944, '信息管理', '获取', 'hq', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 4, '前台获取所有前台首页Banner图片', '2025-08-16 23:33:39', '2025-08-16 23:33:39', 0);
INSERT INTO `sys_log` VALUES (2945, '信息管理', '获取', 'unknown-1702606997', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 13, '前台获取所有前台首页Banner图片', '2025-08-16 23:35:59', '2025-08-16 23:35:59', 0);
INSERT INTO `sys_log` VALUES (2946, '信息管理', '获取', 'hq', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[],\"msg\":\"success\"}', '/banners/list', 4, '前台获取所有前台首页Banner图片', '2025-08-16 23:36:18', '2025-08-16 23:36:18', 0);
INSERT INTO `sys_log` VALUES (2947, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"https://placehold.co/1920x1080/E6A4B4/white?text=Banner+1\",\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"https://placehold.co/1920x1080/9195F6/white?text=Banner+2\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"https://placehold.co/1920x1080/B7C9F2/white?text=Banner+3\"],\"msg\":\"success\"}', '/banners/list', 170, '前台获取所有前台首页Banner图片', '2025-08-16 23:53:11', '2025-08-16 23:53:11', 0);
INSERT INTO `sys_log` VALUES (2948, '信息管理', '获取', 'unknown-1702606997', '103.151.173.197', 'XX', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"https://placehold.co/1920x1080/9195F6/white?text=Banner+2\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"https://placehold.co/1920x1080/B7C9F2/white?text=Banner+3\"],\"msg\":\"success\"}', '/banners/list', 53, '前台获取所有前台首页Banner图片', '2025-08-17 00:05:37', '2025-08-17 00:05:37', 0);
INSERT INTO `sys_log` VALUES (2949, '信息管理', '获取', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.backGetBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[{\"createTime\":1755330732000,\"id\":41,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"size\":153600,\"sortOrder\":1,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755330512000,\"id\":39,\"path\":\"https://placehold.co/1920x1080/9195F6/white?text=Banner+2\",\"size\":122880,\"sortOrder\":2,\"type\":\"image/png\",\"userId\":1},{\"createTime\":1755330732000,\"id\":42,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"size\":184320,\"sortOrder\":2,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755330512000,\"id\":40,\"path\":\"https://placehold.co/1920x1080/B7C9F2/white?text=Banner+3\",\"size\":112640,\"sortOrder\":3,\"type\":\"image/png\",\"userId\":1}],\"msg\":\"success\"}', '/banners/back/list', 116, '后台获取所有前台首页Banner图片', '2025-08-17 00:29:09', '2025-08-17 00:29:09', 0);
INSERT INTO `sys_log` VALUES (2950, '信息管理', '删除', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.delete()', '[39]', 'DELETE', NULL, '{\"code\":200,\"data\":\"删除成功\",\"msg\":\"success\"}', '/banners/39', 2333, '删除前台首页Banner图片', '2025-08-17 00:29:14', '2025-08-17 00:29:14', 0);
INSERT INTO `sys_log` VALUES (2951, '信息管理', '获取', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.backGetBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[{\"createTime\":1755330732000,\"id\":41,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"size\":153600,\"sortOrder\":1,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755330732000,\"id\":42,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"size\":184320,\"sortOrder\":2,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755330512000,\"id\":40,\"path\":\"https://placehold.co/1920x1080/B7C9F2/white?text=Banner+3\",\"size\":112640,\"sortOrder\":3,\"type\":\"image/png\",\"userId\":1}],\"msg\":\"success\"}', '/banners/back/list', 42, '后台获取所有前台首页Banner图片', '2025-08-17 00:29:15', '2025-08-17 00:29:15', 0);
INSERT INTO `sys_log` VALUES (2952, '信息管理', '删除', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.delete()', '[40]', 'DELETE', NULL, '{\"code\":200,\"data\":\"删除成功\",\"msg\":\"success\"}', '/banners/40', 93, '删除前台首页Banner图片', '2025-08-17 00:29:17', '2025-08-17 00:29:17', 0);
INSERT INTO `sys_log` VALUES (2953, '信息管理', '获取', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.backGetBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[{\"createTime\":1755330732000,\"id\":41,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"size\":153600,\"sortOrder\":1,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755330732000,\"id\":42,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"size\":184320,\"sortOrder\":2,\"type\":\"image/jpeg\",\"userId\":1}],\"msg\":\"success\"}', '/banners/back/list', 36, '后台获取所有前台首页Banner图片', '2025-08-17 00:29:19', '2025-08-17 00:29:19', 0);
INSERT INTO `sys_log` VALUES (2954, '信息管理', '新增', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.uploadArticleImage()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@5359b683]', 'POST', NULL, '{\"code\":200,\"data\":{\"createTime\":1755361790469,\"id\":43,\"path\":\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"size\":65865,\"sortOrder\":3,\"type\":\"image/jpeg\",\"userId\":1},\"msg\":\"success\"}', '/banners/upload/banner', 306, '添加前台首页Banner图片', '2025-08-17 00:29:51', '2025-08-17 00:29:51', 0);
INSERT INTO `sys_log` VALUES (2955, '信息管理', '新增', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.uploadArticleImage()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@75ba5e21]', 'POST', NULL, '{\"code\":200,\"data\":{\"createTime\":1755361791774,\"id\":44,\"path\":\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"size\":170464,\"sortOrder\":4,\"type\":\"image/jpeg\",\"userId\":1},\"msg\":\"success\"}', '/banners/upload/banner', 225, '添加前台首页Banner图片', '2025-08-17 00:29:52', '2025-08-17 00:29:52', 0);
INSERT INTO `sys_log` VALUES (2956, '信息管理', '获取', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.backGetBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[{\"createTime\":1755330732000,\"id\":41,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"size\":153600,\"sortOrder\":1,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755330732000,\"id\":42,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"size\":184320,\"sortOrder\":2,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755361790000,\"id\":43,\"path\":\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"size\":65865,\"sortOrder\":3,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755361792000,\"id\":44,\"path\":\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"size\":170464,\"sortOrder\":4,\"type\":\"image/jpeg\",\"userId\":1}],\"msg\":\"success\"}', '/banners/back/list', 29, '后台获取所有前台首页Banner图片', '2025-08-17 00:29:52', '2025-08-17 00:29:52', 0);
INSERT INTO `sys_log` VALUES (2957, '信息管理', '新增', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.uploadArticleImage()', '[org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@2bbe546c]', 'POST', NULL, '{\"code\":200,\"data\":{\"createTime\":1755361793814,\"id\":45,\"path\":\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\",\"size\":210929,\"sortOrder\":5,\"type\":\"image/jpeg\",\"userId\":1},\"msg\":\"success\"}', '/banners/upload/banner', 98, '添加前台首页Banner图片', '2025-08-17 00:29:54', '2025-08-17 00:29:54', 0);
INSERT INTO `sys_log` VALUES (2958, '信息管理', '获取', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.backGetBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[{\"createTime\":1755330732000,\"id\":41,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"size\":153600,\"sortOrder\":1,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755330732000,\"id\":42,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"size\":184320,\"sortOrder\":2,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755361790000,\"id\":43,\"path\":\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"size\":65865,\"sortOrder\":3,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755361792000,\"id\":44,\"path\":\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"size\":170464,\"sortOrder\":4,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755361794000,\"id\":45,\"path\":\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\",\"size\":210929,\"sortOrder\":5,\"type\":\"image/jpeg\",\"userId\":1}],\"msg\":\"success\"}', '/banners/back/list', 33, '后台获取所有前台首页Banner图片', '2025-08-17 00:29:54', '2025-08-17 00:29:54', 0);
INSERT INTO `sys_log` VALUES (2959, '信息管理', '获取', 'ADMIN', '103.151.173.207', 'XX', 0, 'xyz.kuailemao.controller.BannersController.backGetBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[{\"createTime\":1755330732000,\"id\":41,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"size\":153600,\"sortOrder\":1,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755330732000,\"id\":42,\"path\":\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"size\":184320,\"sortOrder\":2,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755361790000,\"id\":43,\"path\":\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"size\":65865,\"sortOrder\":3,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755361792000,\"id\":44,\"path\":\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"size\":170464,\"sortOrder\":4,\"type\":\"image/jpeg\",\"userId\":1},{\"createTime\":1755361794000,\"id\":45,\"path\":\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\",\"size\":210929,\"sortOrder\":5,\"type\":\"image/jpeg\",\"userId\":1}],\"msg\":\"success\"}', '/banners/back/list', 35, '后台获取所有前台首页Banner图片', '2025-08-17 00:29:55', '2025-08-17 00:29:55', 0);
INSERT INTO `sys_log` VALUES (2960, '信息管理', '获取', 'unknown-1702606997', '116.162.95.250', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 1033, '前台获取所有前台首页Banner图片', '2025-08-17 00:30:45', '2025-08-17 00:30:45', 0);
INSERT INTO `sys_log` VALUES (2961, '信息管理', '获取', 'unknown-1702606997', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 7, '前台获取所有前台首页Banner图片', '2025-08-17 09:47:44', '2025-08-17 09:47:44', 0);
INSERT INTO `sys_log` VALUES (2962, '相册管理', '获取', 'unknown-1702606997', '116.162.227.138', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[1,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 57, NULL, '2025-08-17 09:48:48', '2025-08-17 09:48:48', 0);
INSERT INTO `sys_log` VALUES (2963, '相册管理', '获取', 'unknown-1702606997', '116.162.227.138', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 20, NULL, '2025-08-17 09:48:53', '2025-08-17 09:48:53', 0);
INSERT INTO `sys_log` VALUES (2964, '相册管理', '获取', 'unknown-1702606997', '116.162.227.138', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 27, NULL, '2025-08-17 09:48:56', '2025-08-17 09:48:56', 0);
INSERT INTO `sys_log` VALUES (2965, '相册管理', '获取', 'unknown-1702606997', '116.162.227.138', '辽宁', 2, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', '\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n### The error may exist in xyz/kuailemao/mapper/PhotoMapper.java (best guess)\n### The error may involve defaultParameterMap\n### The error occurred while setting parameters\n### SQL: SELECT COUNT(*) AS total FROM t_photo WHERE is_deleted = 0 AND (parent_id IS NULL)\n### Cause: java.sql.SQLSyntaxErrorException: Table \'Ruyu-Blog.t_photo\' doesn\'t exist\n; bad SQL grammar []', NULL, '/photo/list', 8, NULL, '2025-08-17 09:48:57', '2025-08-17 09:48:57', 0);
INSERT INTO `sys_log` VALUES (2966, '相册管理', '获取', 'unknown-1702606997', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.PhotoController.getList()', '[2,16,null]', 'GET', NULL, '{\"code\":200,\"data\":{\"page\":[],\"total\":0},\"msg\":\"success\"}', '/photo/list', 17, '前台相册或照片列表', '2025-08-17 09:51:54', '2025-08-17 09:51:54', 0);
INSERT INTO `sys_log` VALUES (2967, '相册管理', '获取', 'unknown-1702606997', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.PhotoController.getList()', '[1,16,null]', 'GET', NULL, '{\"code\":200,\"data\":{\"page\":[],\"total\":0},\"msg\":\"success\"}', '/photo/list', 12, '前台相册或照片列表', '2025-08-17 09:52:10', '2025-08-17 09:52:10', 0);
INSERT INTO `sys_log` VALUES (2968, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 4, '前台获取所有前台首页Banner图片', '2025-08-17 09:53:03', '2025-08-17 09:53:03', 0);
INSERT INTO `sys_log` VALUES (2969, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 10, '前台获取所有前台首页Banner图片', '2025-08-17 10:14:40', '2025-08-17 10:14:40', 0);
INSERT INTO `sys_log` VALUES (2970, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 3, '前台获取所有前台首页Banner图片', '2025-08-17 10:14:54', '2025-08-17 10:14:54', 0);
INSERT INTO `sys_log` VALUES (2971, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 2, '前台获取所有前台首页Banner图片', '2025-08-17 10:15:17', '2025-08-17 10:15:17', 0);
INSERT INTO `sys_log` VALUES (2972, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 4, '前台获取所有前台首页Banner图片', '2025-08-17 10:15:24', '2025-08-17 10:15:24', 0);
INSERT INTO `sys_log` VALUES (2973, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 9, '前台获取所有前台首页Banner图片', '2025-08-17 10:15:27', '2025-08-17 10:15:27', 0);
INSERT INTO `sys_log` VALUES (2974, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 2, '前台获取所有前台首页Banner图片', '2025-08-17 10:15:30', '2025-08-17 10:15:30', 0);
INSERT INTO `sys_log` VALUES (2975, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 7, '前台获取所有前台首页Banner图片', '2025-08-17 10:15:42', '2025-08-17 10:15:42', 0);
INSERT INTO `sys_log` VALUES (2976, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 4, '前台获取所有前台首页Banner图片', '2025-08-17 10:15:46', '2025-08-17 10:15:46', 0);
INSERT INTO `sys_log` VALUES (2977, '信息管理', '获取', 'hq', '116.162.227.138', '辽宁', 0, 'xyz.kuailemao.controller.BannersController.getBanners()', '[]', 'GET', NULL, '{\"code\":200,\"data\":[\"http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg\",\"http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg\",\"http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg\",\"http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg\",\"http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg\"],\"msg\":\"success\"}', '/banners/list', 2, '前台获取所有前台首页Banner图片', '2025-08-17 10:15:51', '2025-08-17 10:15:51', 0);
...
CREATE TABLE `sys_login_log`  (
  ...
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '登录地址',
...
INSERT INTO `sys_permission` VALUES (149, '后台获取轮播图列表', 'blog:banner:list', 40, '2025-08-16 16:19:52', '2025-08-16 16:19:52', 0);
INSERT INTO `sys_permission` VALUES (150, '删除轮播图', 'blog:banner:delete', 40, '2025-08-16 16:27:22', '2025-08-16 16:27:22', 0);
INSERT INTO `sys_permission` VALUES (151, '添加轮播图', 'blog:banner:add', 40, '2025-08-16 16:27:22', '2025-08-16 16:27:22', 0);
INSERT INTO `sys_permission` VALUES (152, '修改轮播图顺序', 'blog:banner:update', 40, '2025-08-16 16:27:22', '2025-08-16 16:27:22', 0);
...
INSERT INTO `sys_role_permission` VALUES (271, 1, 149);
INSERT INTO `sys_role_permission` VALUES (272, 1, 150);
INSERT INTO `sys_role_permission` VALUES (273, 1, 151);
INSERT INTO `sys_role_permission` VALUES (274, 1, 152);
...
CREATE TABLE `sys_user`  (
  ...
  `register_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'ADMIN', 'ADMIN', 0, '$2a$10$VyFtQ3T943p3NY5R0IxzIONjdqABmuCSGiHe5uV8d1ujLGYuS2KZe', 'http://cdn.kuailemao.lielfw.cn/articleCover/Sara11676693014447852.png', '该用户比较懒还未添加简介', 'test@qq.com', '127.0.0.1', 0, '内网IP', '103.151.173.197', 'XX', 0, '2025-08-16 20:20:51', 0, '2023-10-13 15:16:01', '2025-08-16 20:20:51', 0);
...
INSERT INTO `sys_user` VALUES (88065989, '血小板', 'hq', 2, '$2a$10$q6OOUlDhVMZ261NaeChVB.67zmN0jKKqTcBiUtOLTfv2GdnudHOym', 'http://8.148.31.90:9000/blog/user/avatar/8f3ccb27-7976-4a32-93e2-55e220084bf9.jpg', '我是测试用户', '1911779729@qq.com', '116.162.95.250', 0, '辽宁', '116.162.227.138', '辽宁', 0, '2025-08-17 09:53:03', 0, '2025-08-16 23:32:08', '2025-08-17 09:53:03', 0);
...
-- ----------------------------
INSERT INTO `t_article` VALUES (1, 1, 2, 'http://8.148.31.90:9000/blog/article/articleCover/f1e08d92-61d9-499b-8f52-9043b6f7030d.jpg', 'java的继承', '# 🍖2、继承\n#### 🍟2.1、继承的基本概念\n> 继承是面向对象的三大特征之一，继承可以解决编程中代码冗余的问题，是实现代码重用的重要手段之一。\n> **语法：**\n> [ 访问修饰符 ] class  \\<SubClass\\>  extends <SuperClass\\>{\n>\n> }\n\n其中，SubClass 被称为子类或派生类，SuperClass 被称为父类或基类。\n\n> Java 继承规则如下：\n> 1、可以继承父类中 public 和 protected 修饰的属性和方法，不论子类和父类是否在同一包中。\n> 2、可以继承默认访问修饰符修饰的属性和方法，但是子类和父类必须在同一包中\n> 3、无法继承 private 修饰的属性和方法\n> 4、无法继承父类的构造方法\n\n**注意：**\n> 在 Java 中只支持单继承，即每个类只能有一个直接父类\n\n#### 🍟2.2、继承的应用\n如下：\n```java\n    /**\n    *动物父类\n    */\n	public class Animal {\n    public void cry(){\n        System.out.println(\"动物叫。。。。\");\n    }\n}\n	/**\n	*	继承了动物类的小猫类也有 cry() 方法（子类）\n	*/\npublic class Cat extends Animal {\n   // 有父类的方法与属性 \n}\n```\n#### 🍟2.3、Object\n> Object 类属性超级父类（老祖宗），当一个类没有任何继承的时候，默认继承 Object 类，自带 Object 类里面的 方法与属性\n\n**注意：**\n> 子类被创建对象的时候必是先执行 Object 类的构造方法，因为构造方法第一行中有隐藏的 super() 调用父类构造方法，最终的父类一定是 Object 类\n\n#### 🍟2.4、继承关系中的方法重写\n> 子类通过继承可以拥有和父类相同的特征和行为，另外，子类也可以定义自己特有的行为，既沿袭了父类的方法名称，又重新实现了父类方法，这就是方法重写。\n\n> 在子类中可以根据需求对从父类继承的方法进行重写编写，这被称为方法重写或方法覆盖。\n\n**方法重写必须遵守以下规则：**\n* 重写方法和被重写方法必须具有相同的方法名\n* 重写方法和被重写方法必须具有相同的参数列表\n* 重写方法的返回值类型必须和被重写方法的返回值类型相同或是其子类\n* 重写方法不能缩小被重写方法的访问权限\n\n**重写的时候可以在方法上面使用注解：**\n\n> @Override\n> @Override 是用 Java 注解的方法表示该方法重写了父类方法，可以写也可以不写，在功能实现上没有区别，但是通过 @Override 注解，程序更加方便阅读。另外，编译器也会帮助验证 @Override 下面的方法名是否是父类所有的。如果其不符合方法重写规则，则会报错。\n\n**提示：**\n> Java 注解又被称为 Java 标注，是 Java 5 引入的一种注解机制。  \n\n#### 🍟2.5、方法重载和方法重写的区别\n* 方法重载涉及同一个类中的同名方法，要求方法名相同，参数列表不同，与返回值类型和访问修饰符无关\n* 方法重写涉及的是子类和父类之间的同名方法，要求方法名相同，参数列表相同，返回值类型i相同或是其子类\n\n#### 🍟2.6、super关键字\n> 如果想在子类中调用父类的被重写的方法，可以使用 ” super.方法名 “实现\n\nsuper 关键字代表对当前对象的直接父类对象的默认引用。在子类中可以通过 super 关键字访问父类的成员，包括父类的属性和方法。语法如下：\n> 语法：\n> 访问父类构造方法 ：super(参数)\n> 访问父类属性 / 方法 ：super.< 父类属性 / 方法 \\>\n\n使用 super 关键字，需要注意以下几点：\n* super 关键字必须出现在子类（子类的方法和构造方法）中，而不允许在其他位置。\n* 可以访问父类的成员，如父类的属性，方法，构造方法。\n* 注意访问权限的限制，如无法通过 super 关键字访问 private 成员。\n\n**注意：**\n\n> 1、在构造方法中如果有 this 语句或 super 语句，则只能是第一条语句。\n> 2、在一个构造方法中，不允许同时使用 this 关键字和 super 关键字调用构造方法（否则就有两条第一条语句）。\n> 3、在静态方法中不允许出现 this 关键字或 super 关键字。\n> 4、在实例方法中，this 语句和 super 语句不要求是第一条语句，可以共存。\n> 5、子类构造方法中第一行有隐藏的 **super( )** 调用父类构造方法，最终父类一定是 Object 类\n\n#### 🍟2.7、继承关系中的构造方法\n在 Java 中，一个类的构造方法在如下两种情况下会被执行：\n* 创建该类对象（实例化）\n* 创建该类的子类对象（子类的实例化）\n\n> 子类在实例化时，会首先执行其父类的构造方法，然后才会执行子类的构造方法。\n> 在 Java 语言中，当创建一个对象时，Java 虚拟机（JVM）会按照父类——>子类的顺序执行一系列的构造方法。\n\n**子类继承父类时构造方法的调用规则如下：**\n* 如果在类的构造方法中没有通过 super 关键字显式调用父类地带参构造方法，也没有通过 this 关键字显式调用自身地其他构造方法，则系统会默认先调用父类的无参构造方法。在这种情况下，是否写 “ super( );  ”语句，效果是一样的。\n* 如果在子类的构造方法中通过 super 关键字显式地调用了父类地带参构造方法，那么将执行父类相应的构造方法，而不执行父类无参构造方法。\n* 如果在子类的构造方法中通过 this 关键字显式地调用了自身地其他构造方法，那么在相应构造方法中遵循以上两条规则。\n* 如果存在多级继承关系，则在创建一个子类对象时，以上规则会多次向上更高一级父类应用，直到执行顶级父类 Object 类的无参构造方法为止。\n\n<center>-----------------------<b style=\"color:#C3C326\">世界会向那些有目标和远见的人让路。</b>-----------------------</center>', 1, 1, 1, 268, '2023-10-15 02:26:45', '2025-08-16 20:41:39', 0);
...
INSERT INTO `t_article` VALUES (3, 1, 2, 'http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg', '今天出去玩了', '好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，', 1, 0, 1, 134, '2023-10-15 02:26:45', '2025-08-16 20:41:59', 0);
INSERT INTO `t_article` VALUES (24, 1, 3, 'http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg', '测试分类3', '好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，好好玩啊，', 1, 0, 1, 131, '2023-10-15 02:26:45', '2025-08-16 20:43:26', 0);
INSERT INTO `t_article` VALUES (32, 1, 4, 'http://8.148.31.90:9000/blog/article/articleCover/2aa6ea41-dee3-4381-93b0-b520a494403a.jpg', '测试文章', '## 这是一篇测试文章\n> 你看见这篇文章说明后台发布文章功能成功\n\n```mermaid\ngantt\ntitle A Gantt Diagram\ndateFormat  YYYY-MM-DD\nsection Section\nA task  :a1, 2014-01-01, 30d\nAnother task  :after a1, 20d\n```\n\n### 图表\n```mermaid\nclassDiagram\n  class Animal\n  Vehicle <|-- Car\n```\n', 1, 0, 1, 9, '2024-01-04 21:32:19', '2025-08-16 20:42:17', 0);
...
INSERT INTO `t_article` VALUES (40, 1, 1, 'http://8.148.31.90:9000/blog/article/articleCover/eb549b9e-027a-4224-ac0d-2ff679afc2fb.jpg', '测试', '新文章', 1, 0, 1, 2, '2024-02-28 14:05:36', '2025-08-16 20:43:08', 0);
...
INSERT INTO `t_article_tag` VALUES (80, 1, 1, '2025-08-16 20:41:39', 0);
INSERT INTO `t_article_tag` VALUES (81, 1, 2, '2025-08-16 20:41:39', 0);
INSERT INTO `t_article_tag` VALUES (82, 1, 3, '2025-08-16 20:41:39', 0);
INSERT INTO `t_article_tag` VALUES (83, 3, 3, '2025-08-16 20:41:59', 0);
INSERT INTO `t_article_tag` VALUES (84, 3, 5, '2025-08-16 20:41:59', 0);
INSERT INTO `t_article_tag` VALUES (85, 32, 2, '2025-08-16 20:42:17', 0);
INSERT INTO `t_article_tag` VALUES (86, 32, 3, '2025-08-16 20:42:17', 0);
INSERT INTO `t_article_tag` VALUES (87, 40, 2, '2025-08-16 20:43:08', 0);
INSERT INTO `t_article_tag` VALUES (88, 24, 2, '2025-08-16 20:43:26', 0);
INSERT INTO `t_article_tag` VALUES (89, 24, 4, '2025-08-16 20:43:26', 0);
...
-- ----------------------------
INSERT INTO `t_banners` VALUES (41, 'http://8.148.31.90:9000/blog/article/articleCover/46deb90f-15d7-4612-9902-ab2e087f9ce8.jpg', 153600, 'image/jpeg', 1, 1, '2025-08-16 15:52:12');
INSERT INTO `t_banners` VALUES (42, 'http://8.148.31.90:9000/blog/article/articleCover/e05fc4c4-17da-40ad-b23d-d6d508bddc43.jpg', 184320, 'image/jpeg', 1, 2, '2025-08-16 15:52:12');
INSERT INTO `t_banners` VALUES (43, 'http://8.148.31.90:9000/blog/banners/39fea894-1e12-428c-8a63-a738e7f8e448.jpg', 65865, 'image/jpeg', 1, 3, '2025-08-17 00:29:50');
INSERT INTO `t_banners` VALUES (44, 'http://8.148.31.90:9000/blog/banners/84a6a910-4a58-47aa-a2b0-1b399fd22c5c.jpg', 170464, 'image/jpeg', 1, 4, '2025-08-17 00:29:52');
INSERT INTO `t_banners` VALUES (45, 'http://8.148.31.90:9000/blog/banners/0bf3f86b-5035-407f-b91c-f4cd6599ffc8.jpg', 210929, 'image/jpeg', 1, 5, '2025-08-17 00:29:54');

-- ----------------------------
-- Table structure for t_banners_copy1
-- ----------------------------
DROP TABLE IF EXISTS `t_banners_copy1`;
CREATE TABLE `t_banners_copy1`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片路径',
  `size` bigint NOT NULL COMMENT '图片大小 (字节)',
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片类型 (MIME)',
...
CREATE TABLE `t_black_list`  (
  ...
  `type` tinyint NOT NULL COMMENT '12/',
  `ip_info` json NULL COMMENT 'type=2ip',
  `create_time` datetime NOT NULL,
  `update_time` datetime NOT NULL,
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '01',
  PRIMARY KEY (`id`) USING BTREE
